# 🤝 Contributing to Modmail Bot

Thank you for considering contributing to **Modmail Bot**!
...
- Clone your fork locally:
  ```bash
  git clone https://github.com/your-username/modmailbot.git
  cd modmailbot
  ```
...
- Commit your work with a meaningful message:
  ```bash
  git commit -m "Fix thread creation error"
  ```
...
_Thank you for taking time to contribute to Modmail Bot ✨_
